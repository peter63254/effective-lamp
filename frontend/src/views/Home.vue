  ...
  <div class="home">
    ...
    <div class="hero">
      <div class="hero-content">
        <h1>Flower Shop</h1>
        <p>Discover the beauty of nature - browse our collection of fresh flowers</p>
    ...
    <div class="filter-section" id="flowers">
      <el-row :gutter="20" class="filter-row">
        ...
        <el-col :span="12" class="filter-controls">
          <el-select v-model="selectedCategory" placeholder="Filter by category" clearable @change="loadFlowers">
            <el-option
    ...
    <div v-else-if="flowers.length === 0" class="empty-container">
      <el-empty description="No flowers found" />
    </div>
